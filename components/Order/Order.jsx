    ...
    return (
        <>
            ...
            <div className='mb-[4rem]'>
                ...
                <div className='flex'>
                <p className='font-light bg-[#f0f0f080] px-[1.4rem] py-[0.8rem] rounded-lg'>Kreirana: <span className='font-medium'>{previousOrders?.order?.created_at}</span></p>
                <p className='font-light bg-[#f0f0f080] px-[1.4rem] py-[0.8rem] rounded-lg mx-[0.6rem]'>Način dostave: <span className='font-medium'>{previousOrders?.order?.delivery_method}</span></p>
                <p className='font-light bg-[#f0f0f080] px-[1.4rem] py-[0.8rem] rounded-lg'>Način plaćanja: <span className='font-medium'>{previousOrders?.order?.payment_method}</span></p>
                </div>

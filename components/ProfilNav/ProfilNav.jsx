...
const ProfilNav = ({ selectedButton, handleButtonClick }) => {
  ...
  return (
    <>
          ...
          <button
            className={`text-start py-[1.2rem] pl-[1rem] rounded-lg transition-all ease ${
              selectedButton === 0
                ...
                : " hover:bg-croonus-3 hover:text-white bg-[#f0f0f080]"
            }`}
      ...
      <div className="lg:hidden p-2 bg-[#f0f0f080] absolute rounded-3xl">
        ...
        >
          ...
          <button
            ...
            className="ml-auto mt-[1rem] mr-[1rem]  p-2 bg-[#f0f0f080] rounded-3xl"
          >
            <Image
              src={profilecancel}
              width={30}

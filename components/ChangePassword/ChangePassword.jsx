...
const ChangePassword = () => {
    ...
    const submitHandler = () => {
      ...
      const togglePasswordVisibility = () => {
        setShowChangedPassword((prevShowChangedPassword) => !prevShowChangedPassword);
      };
    ...
    return(
        <div>
          <ToastContainer />
            ...
            <div className="flex mt-[3rem] md:w-[64%]">
            <input 
            name="password"
            ...
            className="block lg:w-full bg-[#f5f5f6] border-0 py-[0.6rem] rounded-lg"/>
            ...
            <div className='mt-4'>
                ...
                Pošalji mi izmenjenu lozinku na mail. </label>
            </div>
            
            <button onClick={submitHandler} className="bg-croonus-3 text-white py-[0.8rem] px-[4rem] max-sm:px-[1rem] hover:bg-opacity-80 mt-[3rem] rounded-lg">Potvrdite</button>
        </div>
    )
};

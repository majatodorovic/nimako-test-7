        ...
        <div>
          ...
          <div className='flex justify-between items-center sm:w-[90%] bg-[#f8f8f8] rounded-lg p-[1.4rem] mb-[2rem] min-h-[7rem]'>
            <h1 className="text-3xl pb-0">Adrese dostave</h1> 
              <a href="/nova-shipping-adresa" className='text-[#919191] opacity-[0.5] hover:opacity-100 px-[1rem] text-xl h-fit py-[0.6rem] max-sm:px-[0.5rem] whitespace-nowrap rounded-md hover:translate-y-0.5 transition-all ease cursor-pointer font-semibold flex'> 
            ...
            <>
             ...
             <tr className={`divide-x divide-white ${index % 2 !== 0 ? "bg-[#ededed]" : "bg-[#f0f0f080]"}`}>
                ...
                <td className=" md:pl-[1.4rem] py-[0.7rem] max-sm:text-sm pl-[0.4rem]">
                    <a href={`/customer-shipping/${address?.id}`} className="max-sm:text-sm">Pogledaj više</a>
                </td>
                
                <td className=" sm:pl-[2rem] py-[0.7rem] pl-[0.4rem]">
                    <div className='flex'>
                    <a href={`/customer-shipping/${address?.id}`} className=' mr-[0.8rem] hover:translate-y-0.5 transition-all ease cursor-pointer'>
                    <Image
                    src={pen}
                    alt="change address"
                    width={22}
